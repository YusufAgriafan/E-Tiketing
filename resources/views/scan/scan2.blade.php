                        ...
                        $.ajax({
                                ...
                                <div style="text-align: left; font-family: 'Arial', sans-serif; line-height: 1.6;">
                                    ...
                                    <p style="margin-bottom: 2px;">Scan Register untuk
                                            ...
                                            ${Array.from({ length: response.data.remaining_participants }, (_, i) => ` <
                                                            option value = "${i + 1}" > $ {
                                                                i + 1
                                                            } < /option>`).join('')} <
                                                        /select>
                                                    orang <
                                                    /p> <
                                                    p > Sisa peserta yang belum masuk venue < b > < span id =
                                                    "remaining_participants" > $ {
                                                        response.data.remaining_participants
                                                    } < /span></b > orang < /p> <
                                                    p > Silakan menuju venue dan selamat menikmati acara. < /p> <
                                                    br >
                                                    <
                                                    p style = "font-size: 16px; margin-bottom: 2px;" > Salam,
                                                    < /p> <
                                ...
                                if (result.isConfirmed) {
                                    Swal.fire({
                                        title: "Konfirmasi",
                                        text: `
                                                    Apakah Anda yakin ingin menyimpan data dengan jumlah peserta sebanyak $ {
                                                        result.value.naik_kapal
                                                    }
                                                    orang ? `,
                                        icon: "warning",
