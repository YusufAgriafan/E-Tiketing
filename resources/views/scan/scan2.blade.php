<x-layout2>
    <div class="container py-4">
        <h1 class="h3 text-white text-center fw-bold mb-4">Scanner 2</h1>
                        ...
                        Swal.fire({
                            html: `
                                <div style="text-align: left; font-family: 'Arial', sans-serif; line-height: 1.6;">
                                    <p>Pembayaran sebesar <b>Rp ${response.data.harga}</b> untuk <b>${response.data.jumlah_peserta} orang</b> telah terkonfirmasi.</p>
                                    <p style="margin-bottom: 2px;">Scan Register untuk
                                        <select id="naik_kapal" name="naik_kapal" style="width: 75px; padding: 6px; border-radius: 5px; cursor: pointer;">
                                            ${Array.from({ length: response.data.remaining_participants }, (_, i) => `<option value="${i + 1}">${i + 1}</option>`).join('')}
                                        </select>
                                        orang
                                    </p>
                                    <p>Sisa Peserta belum terscan <b><span id="remaining_participants">${response.data.remaining_participants}</span></b> orang</p>
