                        ...
                        <div class="row mb-3 participant-row">
                            <div class="col-md-6">
                                ...
                                <div class="custom-select">
                                    <select class="form-control participant-type">
                                        <option disabled selected>Tipe Peserta</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control participant-count" min="0" />
                            </div>
                        </div>
                    </div>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function hitungHarga() {
                ...
                participantRows.forEach(row => {
                    ...
                    const count = parseInt(row.querySelector(".participant-count").value) || 0;
                    if (type === "dewasa") {
                        totalHarga += count * 1000000;
                        totalDewasa += count;
                    } else if (type === "anak") {
                        totalHarga += count * 1000000;
                        totalAnak += count;
            ...
            addParticipantBtn.addEventListener("click", function() {
                ...
                newRow.querySelector(".participant-count").addEventListener("input", hitungHarga);
            });
